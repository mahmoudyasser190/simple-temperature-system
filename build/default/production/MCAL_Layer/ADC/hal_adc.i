...
# 35 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/mcal_internal_interrupt.h"
...
static __attribute__((inline)) void adc_input_channel_port_configuration(const ADC_CHANNEL_SELECT_t channel);
static __attribute__((inline)) void adc_select_format(const adc_cfg_t *adc);
static __attribute__((inline)) void configure_the_voltage_reference(const adc_cfg_t *adc);
...
Std_ReturnType ADC_get_conversion_result(const adc_cfg_t *adc, adc_result_t *conversion_result)
{
    ...
    else
    {
        ...
        {
               case 0x01:*conversion_result= (adc_result_t)((ADRESH<<8)+ADRESL);break;
               case 0x00:*conversion_result= (adc_result_t)(((ADRESH<<8)+ADRESL) >> 6);break;
...
static __attribute__((inline)) void adc_select_format(const adc_cfg_t *adc)
{
    ...
    else
    {
        switch(adc->result_format)
        {
               case 0x01:(ADCON2bits.ADFM=1);break;
               case 0x00:(ADCON2bits.ADFM=0);break;
            default:(ADCON2bits.ADFM=1);
...
static __attribute__((inline)) void configure_the_voltage_reference(const adc_cfg_t *adc)
{
    ...
    else
    {
        ...
        {
               case 0X01:do{ADCON1bits.VCFG0=1; ADCON1bits.VCFG1=1; }while(0);;break;
               case 0X00:do{ADCON1bits.VCFG0=0; ADCON1bits.VCFG1=0; }while(0);;break;
            default:do{ADCON1bits.VCFG0=0; ADCON1bits.VCFG1=0; }while(0);;
